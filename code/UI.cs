...
public class UI : MonoBehaviour
{
    ...
    private string War_towerName = "VezLv1Mage";
    ...
    void buildWar_tower(GameObject prefab, float PosX, float PosY, float PosZ)
    {
        ...
        {
            Instantiate(prefab, new Vector3(PosX, 1.5f + PosY, PosZ), Quaternion.Euler(0, 0, 0));
    ...
    private void Start()
    {
        ...
        GameObject WarTower =  Resources.Load("VezLv1Mage") as GameObject;
